<link rel="stylesheet" href="../../../../../mimall-vue3/src/assets/scss/base.scss">
<template>
    <div class="product">
        <product-param v-bind:title="product.value.name">
            <template v-slot:buy>
        ...
        <div class="content">
            <div class="item-bg-1">
                ...
                <div class="price">
                    <span>¥<em>{{product.value.price}}</em></span>
                </div>
            </div>
            <div class="item-bg-2">
                <div class="container">
            ...
            <div class="item-swiper">
                <a-carousel class="swiperClass" autoplay :slides-to-show="3" :slides-to-scroll="1">
                    <div class="swiper-item" v-for="(item, index) in swiperList" v-bind:key="index">
